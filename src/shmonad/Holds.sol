...
abstract contract ShMonadHolds is ShMonadStorage {
    ...
    /// @dev If a hold is already active for an account, the new amount is added to the existing hold. Held shares
    /// cannot
