...
contract Simulator is AtlasErrors, AtlasConstants {
        ...
        returns (uint256 metacallCalldataGas, uint256 metacallExecutionGas)
    {
        ...
        address l2GasCalculator = address(0); // No L2GasCalculator on Monad
        ...
        payable
    {
        ...
        // limit. However, as this is a Simulator call, that calldata gas has already been deducted in the initial
