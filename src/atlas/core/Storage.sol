...
abstract contract Storage is AtlasEvents, AtlasErrors, AtlasConstants {
    ...
    // On Monad, balances are handled by ShMonad - this mapping only tracks analytics
    mapping(address => AccountAnalytics) internal S_accessData;
    ...
    {
        AccountAnalytics memory _aData = S_accessData[account];
