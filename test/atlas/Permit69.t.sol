...
import { SAFE_USER_TRANSFER, SAFE_DAPP_TRANSFER } from "../../src/atlas/core/Permit69.sol";
import { AtlasErrors } from "../../src/atlas/types/AtlasErrors.sol";
import { ExecutionPhase } from "../../src/atlas/types/LockTypes.sol";

contract Permit69Test is AtlasBaseTest {
    ...
    function test_Permit69_TransferUserERC20RevertsIfCallerNotExecutionEnv() public {
        ...
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.PreOps));
    ...
    function test_Permit69_TransferUserERC20RevertsIfLockStateNotValid() public {
        ...
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.AllocateValue));
    ...
    function test_Permit69_TransferDAppERC20RevertsIfLockStateNotValid() public {
        ...
        TestAtlas(payable(address(atlas))).setLock(executionEnvironment, 0, uint8(ExecutionPhase.UserOperation));
