...
import { MockL2GasCalculator } from "./helpers/MockL2GasCalculator.sol";
...
contract GasAccLibTest is Test {
    ...
    function test_GasAccLib_solverOpCalldataGas() public view {
        ...
        uint256 expectedDefaultGas = (calldataLength + 608) * 8; // 608 = _SOLVER_OP_BASE_CALLDATA, 8 = _CALLDATA_LENGTH_PREMIUM_HALVED
    ...
    function test_GasAccLib_metacallCalldataGas() public view {
        ...
        // First, the default calculation, using address(0) as the GasCalculator:
        uint256 expectedDefaultGas = msgDataLength * 8; // 8 = _CALLDATA_LENGTH_PREMIUM_HALVED
